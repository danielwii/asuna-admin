...
storiesOf('DynamicForm', module)
  .add('Component Input', () => {
    const WrappedInput                = Form.create()(({ form }) => generateInput(form, {
      name: 'Title',
    }));
    const WrappedRequiredInput        = Form.create()(({ form }) => generateInput(form, {
      name    : 'Title required',
      required: true,
    }));
    const WrappedWithPlaceholderInput = Form.create()(({ form }) => generateInput(form, {
      name       : 'Title with placeholder',
      placeholder: 'type title here.',
    }, { labelCol: { span: 6 }, wrapperCol: { span: 18 } }));
    const WrappedWithOffsetInput      = Form.create()(({ form }) => generateInput(form, {
