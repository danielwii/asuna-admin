...
describe('uniqueItems', () => {
  it('should return unique items by array', () => {
    expect(uniqueItems([['A', 'a'], ['B', 'b']], [['A', '1'], ['C', '3']])).toEqual([
      ['A', 'a'],
      ['B', 'b'],
      ['C', '3'],
    ]);
  ...
  it('should return unique items by object with id', () => {
    ...
    ).toEqual([{ id: 'A', value: 'a' }, { id: 'B', value: 'b' }, { id: 'C', value: '3' }]);
  });
  it('should return unique items by object with key', () => {
    ...
    ).toEqual([{ key: 'A', value: 'a' }, { key: 'B', value: 'b' }, { key: 'C', value: '3' }]);
  });
  it('should return unique items by object with first key', () => {
    expect(
      uniqueItems(
        [{ _first_: 'A', value: 'a' }, { _first_: 'B', value: 'b' }],
        [{ _first_: 'A', value: '1' }, { _first_: 'C', value: '3' }],
      ),
    ).toEqual([
      { _first_: 'A', value: 'a' },
      { _first_: 'B', value: 'b' },
